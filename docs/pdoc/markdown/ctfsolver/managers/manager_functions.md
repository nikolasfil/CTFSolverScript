Module ctfsolver.managers.manager_functions
===========================================
...
:   ManagerFunction provides utility methods for introspecting and managing functions within a class and Python source files.
    ...
    * ctfsolver.managers.manager_file.ManagerFile
    ...
    `function_object(self, file_path: pathlib._local.Path, function_name: str) ‑> ctfsolver.find_usage.function_definition_class.FunctionDefFinder`
    :
    ...
    `get_functions_from_file(self, file_path: pathlib._local.Path, function_name: str = None) ‑> list[ast.FunctionDef] | None | ast.FunctionDef`
